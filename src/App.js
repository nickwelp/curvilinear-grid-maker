  ...
  return (
    <div className="App">
      ...
      <div style={{maxWidth: "600px", margin: 'auto', textAlign: 'left', fontSize: '12px'}}>
        ...
        <p>Then you can manipulate the size of the primary spheroid. If you set the width and height of the Primary Spheroid to the same as the Clipping Rectangle, the boundries will be at the edge.</p>
